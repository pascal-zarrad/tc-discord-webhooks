# TeamCity Discord WebHooks [![Build Status](https://travis-ci.org/PlayerForceHD/tc-discord-webhooks.svg?branch=master)](https://travis-ci.org/PlayerForceHD/tc-discord-webhooks)
